...
public final class Post implements Model {
  ...
  public interface RatingStep {
    StatusStep rating(Integer rating);
  }
  ...
  public static class Builder implements TitleStep, RatingStep, StatusStep, BuildStep {
    private String id;
    ...
    @Override
     public StatusStep rating(Integer rating) {
